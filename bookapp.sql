...
select book_name,(select quantity from book_stock where book_id = b.book_id) as stock from books b;

insert into book_stock(stock_id,book_id,quantity)values(3,3,15);
